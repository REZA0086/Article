    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='media/users/', verbose_name='عکس پروفایل کاربری')),
                ('description', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='توضیحات کاربر در مورد خود')),
                ('register_date', django_jalali.db.models.jDateField(default=datetime.date(2024, 5, 18), verbose_name='تاریخ ثبت نام')),
